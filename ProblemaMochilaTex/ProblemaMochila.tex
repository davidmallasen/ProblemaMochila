...
\bibitem{wikipedia} Artículos de la enciclopedia libre Wikipedia sobre el problema de la mochila y la lista de 21 problemas NP-completos de Karp.

\bibitem{transparencias} Material de clase sobre algoritmos voraces, programación dinámica y ramificación y poda.

\bibitem{trabAlgGen} Trabajo sobre los algoritmos genéticos hecho en el primer cuatrimestre.

\bibitem{paperAlgGen} Hristakeva-Shrestha, \emph{Solving the 0-1 Knapsack Problem with Genetic Algorithms}, Simpson College \url{http://www.micsymposium.org/mics_2004/Hristake.pdf}
